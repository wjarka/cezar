...
routes={'6':'/git','7':'/git/commits','8':'/git/branches','9':'/github/issues/219','14':'/tasks/fixture-session/changes','15':'/tasks/fixture-session/commits','16':'/tasks/fixture-session/files','27A':'/github/prs/218','27B':'/github/prs/218/changes','27C':'/github/prs/218'}
...
for f in d['frames']:
 ...
 browser('open','http://127.0.0.1:44659'+routes[family])
