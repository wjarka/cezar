...
for(const mock of mocks){
 ...
 else if(mock.path==='/runs/fixture-session/commits')schema=contract.runCommitsResponseSchema;
 else if(mock.path.includes('/repo/changes')||mock.path.includes('/runs/fixture-session/changes'))schema=contract.changesPayloadSchema;
