...
p=json.loads(Path('cezarion.pen').read_text());frameids={n['id'] for n in p['children']};parser=Audit();parser.feed((ROOT/'all-frames.html').read_text())
